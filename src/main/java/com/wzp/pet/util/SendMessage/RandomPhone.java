...
public class RandomPhone {
    ...
    public static  void main(String[] args){
         ...
         * 返回手机号码
         */
      com.wzp.pet.util.RandomPhone randomPhone=new com.wzp.pet.util.RandomPhone();
      System.out.println(randomPhone.getTel());
      System.out.println(randomPhone.getChineseName());
      System.out.println(randomPhone.getAddress());
